...
public class MainPanel extends BasePanel implements ActionClick {
    ...
    public void setUserNameKH(String name) {
    	panelLamViecKhachHang.setTextUsernam(name);
    }
...
//        panelStartApp.setVisible(true);
	...
	@Override
	public void goToPhienKH() {
		panelDangNhap.setVisible(false);
		panelLamViecKhachHang.setVisible(true); 
	}

	@Override
	public List<SanPhamCuaHang> getListSPHeThong() {
		return panelLamViecKhachHang.getListHeThong();
	}

	@Override
	public void passDataToPanelDSSPKH() {
		panelDSSPKhachHang.passListHeThongToModel(panelLamViecKhachHang.getListHeThong());
		panelDSSPKhachHang.setModelList(panelDSSPKhachHang.getModel_sp());
	}

	@Override
	public void addGH(SanPhamCuaHang sp) {
		panelLamViecKhachHang.addSPGH(sp);
	}
    ...
    @Override
    public void passDataToPanelLichSu() {

    }

    @Override
	public void updateGioHangOnDelete(int index) {
		panelLamViecKhachHang.listenOnDelete(index);
	}
